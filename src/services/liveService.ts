...
export class LiveSessionManager {
  ...
  public onMessage: (sender: "user" | "luna", text: string) => void = () => {};
  ...
  async start() {
    try {
      ...
      try {
        ...
        console.warn("Microphone not available, Live Session will only accept text input:", micError);
      }
